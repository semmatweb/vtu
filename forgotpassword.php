<?php require("functions/autoload.php"); ?>
...
>
  <head>
    ...
    <title><?php echo $sitename; ?> | Recover Your Password</title>
  ...
  <body>
      ...
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
          ...
          <div class="card">
            ...
            <p class="mb-4">Provide your register email to get a code.</p>
            ...
            <form id="form-data">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" id="submitBtn">Send Me Code</button>
                </div>
   ...
   <script type="text/javascript">
    ...
    $.ajax({
      url:'app/resources/forgotpassword',
      method:'POST',
      dataType:'json',
      data:formData,
      success:function(response_fd){
      $('#submitBtn').html('Send Me Code');
