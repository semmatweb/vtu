...
<br/>
    ...
    <input type="tel" id="buyer_amount" class="form-control" placeholder="Amount To Deposit" required>
    ...
    <option value="REVERSE">Reverse Payment</option>
    </select>

    <br/>

    <button class="btn btn-success btn-block" type="submit" style="width:100%">FUND WALLET</button>
