...
<div class="mb-3">
  ...
  <input type="text" id="charges" class="form-control" placeholder="Withdraw Charges" value="<?php echo $flyer_charge; ?>">
</div>
...
<script type="text/javascript">
    ...
    $.ajax({
    url:'customer/save_graphiccharge',
    type:"POST",
    data:formData,
    dataType:'json',
