...
$update=mysqli_query($con, "UPDATE mtncg2data_plan SET mtncg_500='$mtncg_500', mtncg_1='$mtncg_1', mtncg_2='$mtncg_2', mtncg_3='$mtncg_3', mtncg_5='$mtncg_5', mtncg_10='$mtncg_10' WHERE id='$level'");

if ($update){

 $response=array(
    'status'=>'success',
    'message' => 'Your mtn-cg 2 prices has been successfully updated !!!',
  );
