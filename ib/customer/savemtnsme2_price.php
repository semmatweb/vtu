...
$update=mysqli_query($con, "UPDATE mtnsme2data_plan SET mtnsme_500='$mtnsme_500', mtnsme_1='$mtnsme_1', mtnsme_2='$mtnsme_2', mtnsme_3='$mtnsme_3', mtnsme_5='$mtnsme_5', mtnsme_10='$mtnsme_10' WHERE id='$level'");

if ($update){

 $response=array(
    'status'=>'success',
    'message' => 'Your mtn-sme 2 prices has been successfully updated !!!',
  );
