...
<head>
	...
	<meta charset="utf-8" />
    <title>FASTLINK | Buy Data, Airtime to cash, Bills Payment</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <link rel="icon" href="static/styling/img/favicon.png">
...
<meta name="theme-color" content="#C623A2">
    ...
    <meta content="FASTLINK- Buy Airtime and Data for all Network. Make payment for DSTV, GOTV, PHCN other services" name="descriptison">

    <meta itemprop="name" content="FASTLINK- Buy Airtime and Data for all Network. Make payment for DSTV, GOTV, PHCN other services">
    ...
    <meta name="twitter:title" content="FASTLINK- Buy Airtime and Data for all Network. Make payment for DSTV, GOTV, PHCN other services">
    ...
    <meta property="og:title" content="FASTLINK- Buy Airtime and Data for all Network. Make payment for DSTV, GOTV, PHCN other services">
    ...
    <meta property="og:site_name" content="FASTLINK"/>
    <meta property="og:url" content="https://www.fastlink.com.ng">
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue2">
				<a href="/profile" class="logo" style="color: white;font-size: 19px;font-weight: bold;margin-right: -70px;">Welcome</a>
					...
					<div class="sidebar-content">
						<div class="user">
							...
							<div class="info">
								<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
									<span>
										Ayomide303
										<span class="user-level">balance: &#8358; 0.0</span>
									</span>
								</a>
						...
						<ul class="nav nav-primary">
								...
								<div class="collapse" id="utilities">
									<ul class="nav nav-collapse">
										<li>
											<a href="/billpayment/"> <span class="sub-item">Bill Payment</span> </a>
										</li>
										<li>
											<a href="/Cablesub/"> <span class="sub-item">Cable Subscription</span> </a>
										</li>
									</ul>
								</div>
							</li>
								...
								<div class="collapse" id="fund">
									<ul class="nav nav-collapse">
										...
										<li>
											<a href="/pay_with_monnify/"> <span class="sub-item">Fund with payment gateway (ATM)</span> </a>
										</li>
										
										
										<li>

											<a href="/autobank/"> <span class="sub-item">Automated Bank Transfer (N50 charge)</span> </a>
										</li>
										
										<li>
											<a href="/Coupon_Payment/"> <span class="sub-item">Fund with coupon</span> </a>
										</li>
						...
						<!--	
							...
							-->
								...
								<a href="/TransferCreate/">
									<i class="fas fa-donate"></i>
									<p>Transfer to other users</p>
								</a>
							</li>
...
<h2 class="w3-center">Fund account with Monnify(ATM / BANK TRANSFER) </h2>
    ...
    <div class="box">
        ...
        <div class="row">
         ...
         <div class="col-sm-8">
          <form method="POST">     <input type="hidden" name="csrfmiddlewaretoken" value="wk4QJaRfdZDRUbOMEYOvo1vZSJR0Edugls8YGslUTKa9Ld48NEdfL7yZw2IIqWXd">
    ...
    <div id="div_id_amount" class="form-group">
            ...
            <label for="id_amount" class=" requiredField">
                ...
                <div class="">
                    <input type="number" name="amount" min="0.0" max="5000.0" step="any" class="numberinput form-control" required id="id_amount">
            ...
            <div class="container">
             ...
             <hr>
              ...
              <input type="submit" value="Continue to Funding" class="w3-orange btn"  >
            </form>
            <center>
            <img  src="https://app.monnify.com/images/logo.svg" height="80px" width ="100px">
          </center>
          </div>
               <div class="col-sm-4">
            <h3>Payment</h3>
...
<script >
	...
	<script type="text/javascript">
		(function () {
			var options = {
			whatsapp: "+2349068825218", // WhatsApp number
