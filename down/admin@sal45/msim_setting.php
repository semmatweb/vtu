...
if (isset($_POST['submit'])){
    ...
    $update=mysqli_query($db, "UPDATE general_setting SET mtn_slot='".$mtn."', glo_slot='".$glo."', airtel_slot='".$airtel."', mobile_slot='".$mobile."' WHERE id='1'");
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="card">
                ...
                <div class="card-body">
                    <h6 class="font-weight-bold">Msplug Sim Settings</h6>
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
