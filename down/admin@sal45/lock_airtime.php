...
if (isset($_POST['submit'])){
    ...
    $update=mysqli_query($db, "UPDATE locker SET mtn_airtime='".$mtn."',glo_airtime='".$glo."',airtel_airtime='".$airtel."',mobile_airtime='".$mobile."' WHERE id='1'");
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="card">
                ...
                <div class="card-body">
                    <h6 class="font-weight-bold">Airtime Services</h6>
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
                            <form name="sendrequest" id ="sendrequest" method="POST"> 
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">MTN AIRTIME VTU<span style="color:red">*</span></label>
                                 ...
                                 <div class="form-group">
                                    <label for="exampleInputPassword1">GLO AIRTIME VTU<span style="color:red">*</span></label>
                                    <select id="glo" class="form-control" name="glo" required="required">
                                      ...
                                      <option value="OFF">DISABLE</option>
                                        ...
                                        <div class="form-group">
                                    <label for="exampleInputPassword1">AIRTEL AIRTIME VTU<span style="color:red">*</span></label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">9MOBILE AIRTIME VTU<span style="color:red">*</span></label>
