...
$get_users = mysqli_query($db,"SELECT * FROM users WHERE block='1' ORDER BY id DESC");
...
$users.='<div class="alert" style="background-color: #fff;border-radius: 10px 5px;color:black">
      ...
      <b>Mobile:</b> '.$mobile.' <span style="float:right;font-weight:bold;">'.$passbtn.'</span><br/>
