...
if (isset($_POST['submit'])){
  ...
  $update=mysqli_query($db, "UPDATE mtnprice SET mtn500mb='".$mtn500mb."', mtn1gb='".$mtn1gb."', mtn2gb='".$mtn2gb."', mtn2gb='".$mtn2gb."', mtn3gb='".$mtn3gb."', mtn5gb='".$mtn5gb."', mtn10gb='".$mtn10gb."' WHERE id='1'");
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="card">
                ...
                <div class="card-body">
                    <h6 class="font-weight-bold">MTN DATA API PRICE</h6>
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
