...
if (isset($_POST['submit'])){
    ...
    $cable_prices=$_POST['cable_prices'];

    $update=mysqli_query($db, "UPDATE general_setting SET cable_prices='".$cable_prices."'");
    if ($update){
                ...
                <form name="sendrequest" id ="sendrequest" method="POST"> 
                   ...
                   <div class="form-group">
                    <label for="exampleInputEmail1">Write Here <span style="color:red">*</span></label>
                       <textarea class="form-control" rows="10" required="required" name="cable_prices" id="cable_prices"><?php echo $cable_prices; ?></textarea>
                    </div>
