...
<h3 class="f_s_25 f_w_700 dark_text">Developer API</h3>
<h5 class="f_s_25 f_w_700 dark_text">Autorization Details</h5>
<button class="btn btn-danger" disabled><a href="freesub.pdf" class="text-light" download>View How to Use Api Documentation</a></button> <br><br>
<!--<button class="btn btn-danger">Generate Api Key</button>-->
<?php 
...
if($token==""){
        ?>
        <input type="submit" class="btn btn-danger" name="btnSubmit" onclick="gen()" value="Generate Api Key">
        <?php
        }else{
        ?>
       <input type="submit" class="btn btn-danger" name="btnSubmit" value="Generate Api Key" disabled>
        <?php
        }
?>
</div>
...
<p style="color: green;font-weight: bold;">See Data Sample Request Below</p>
	...
	'network' => 'MTN','MTN-CG','MTN-DC','AIRTEL','AIRTEL-CG','GLO','GLO-CG','9MOBILE','9MOBILE-CG'<br/>
	'plan_code' => 500,<br/>
	'mobile' => '0813905******',<br/>
...
$url = 'https://<?php echo $domain; ?>/api/data_card';<br/>
$ch = curl_init();<br/>
curl_setopt($ch, CURLOPT_URL, $url);<br/>
curl_setopt($ch, CURLOPT_POST, 1);<br/>
curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode($payload));<br/>
...
<p style="color: green;font-weight: bold;">See Airtime Sample Request Below</p>
	...
	$payload=array(<br/>
	'token' => 'YOUR API TOKEN',<br/>
	'network' => 'AIRTEL-VTU','MTN-VTU','GLO-VTU','9MOBILE-VTU'<br>
	'amount' => 100,<br>
	'mobile' => '07083806229',<br>
	'request_id' => 'REF-UNIQUE72300674352',<br/>
);<br/>

$url = 'https://<?php echo $domain; ?>/api/airtime';<br/>
$ch = curl_init();<br/>
curl_setopt($ch, CURLOPT_URL, $url);<br/>
curl_setopt($ch, CURLOPT_POST, 1);<br/>
curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode($payload));<br/>
...
$url = 'https://<?php echo $domain; ?>/api/cable';<br/>
$ch = curl_init();<br/>
curl_setopt($ch, CURLOPT_URL, $url);<br/>
curl_setopt($ch, CURLOPT_POST, 1);<br/>
curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode($payload));<br/>
...
$url = 'https://<?php echo $domain; ?>/api/bills';<br/>
$ch = curl_init();<br/>
curl_setopt($ch, CURLOPT_URL, $url);<br/>
curl_setopt($ch, CURLOPT_POST, 1);<br/>
curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode($payload));<br/>
...
$url = 'https://<?php echo $domain; ?>/api/epins';<br/>
$ch = curl_init();<br/>
curl_setopt($ch, CURLOPT_URL, $url);<br/>
curl_setopt($ch, CURLOPT_POST, 1);<br/>
curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode($payload));<br/>
