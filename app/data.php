...
<select class="form-control" id="network_module" required>
 ...
 <?php
  ...
  if ($m2_lock1 != 0){
  echo '<option value="MTN2">MTN-SME 2</option>';
  }
  if ($mg_lock1 != 0){
  echo '<option value="MTN-CG">MTN-CG</option>';
  }
  if ($mg2_lock1 != 0){
  echo '<option value="MTN-CG2">MTN-CG 2</option>';
  }
  if ($mdc_lock1 != 0){
  echo '<option value="MTN-DC">MTN-Data Coupon (DC) </option>';
  }
  if ($g_lock1 != 0){
  ...
  if ($mocg_lock1 != 0){
  echo '<option value="9MOBILE-CG">9MOBILE-CG</option>';
  }
  ?>
</select>
</div>
