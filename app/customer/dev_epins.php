...
if (!empty($data['exam_type']) && !empty($data['mobile_no']) && !empty($security)){
$service_module=strtoupper(mysqli_real_escape_string($con, $data['exam_type']));
$service_quantity=mysqli_real_escape_string($con, $data['quantity']);
$mobile_no=mysqli_real_escape_string($con, $data['mobile_no']);
