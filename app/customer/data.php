...
if (!empty($_POST['network_module']) && !empty($_POST['dataplanloader']) && !empty($_POST['mobile_no']) && !empty($_POST['security_pin']) && !empty($_POST['req_token'])){
...
if (strlen($mobile_no)==11 && is_numeric($mobile_no)){
  if ($bypass == 'ON')
  {
    ...
    if ($network_module == 'MTN' ||$network_module == 'MTN2' || $network_module == 'MTN-CG' || $network_module == 'MTN-CG2' || $network_module == 'MTN-DC')
    {
        $number = $mobile_no;
    ...
    if ($network_module == 'AIRTEL' || $network_module == 'AIRTEL-CG')
{
    $number = $mobile_no;
    $newnumber = substr($number, 0, 4);
    $airtel_array = array('0708','0701','0902','0808','0812','0802','0901','0904','0907','0912','0911');
...
if ($network_module == 'GLO' || $network_module == 'GLO-CG')
{
    $number = $mobile_no;
    $newnumber = substr($number, 0, 4);
...
if ($network_module == '9MOBILE' || $network_module == '9MOBILE-CG')
{
    $number = $mobile_no;
    $newnumber = substr($number, 0, 4);
