...
$check_user=mysqli_query($con, "SELECT * FROM users WHERE token='$token'");

if (mysqli_num_rows($check_user)>0){

 //Basic Authorization Verified
 $return_info=mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM users WHERE token='$token' AND block='0'"));
